 ...
 * This class provides beans for logging and header propagation.
 */
...
public class FeignClientConfig {
    ...
    /**
     * Creates a request interceptor that propagates headers from the current request to the Feign client request.
     *
     ...
     * This bean can be replaced with a property configuration
